...
import InquiryBoardDetail from './InquiryBoardDetail'

const initialPosts = [
   { id: 4, title: '문의는 포도가 먹고시픈뎅', author: '레몬라임', date: '2025-01-06', content: 'ㅅㅂ...' },
   ...
   return (
      <div style={{ width: '100%' }}>
         {selectedPost ? ( // ✅ 게시글 클릭 시 상세 페이지 표시
            <InquiryBoardDetail post={selectedPost} onBack={() => setSelectedPost(null)} />
         ) : (
            <>
